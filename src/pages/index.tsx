...
const temp: IDesgin[] = [
  {
    ...
    style: `.app{width:100vw;height:100vh;background-color:black;display:flex;align-items:center;justify-content:center;border-radius:12px;}.Qsgold{color:red}.Qsgols{color:white}`,
    updatedAt: "1"
  },
  {
    id: "1",
    ...
    style: `.app{width:100vw;height:100vh;background-color:blue;display:flex;align-items:center;justify-content:center;border-radius:12px;}.Qsgold{color:red}`,
    updatedAt: "2"
  },
]
